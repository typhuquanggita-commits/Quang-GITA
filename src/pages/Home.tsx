...
export default function Home() {
  ...
  return (
    <div className="space-y-10">
      ...
      <section>
        <SectionTitle
          eyebrow="Năm luồng — một hệ thống"
      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { label: 'Phiếu luyện', value: '3.000', sub: `${stats.chuyen} chuyên · ${stats.thpt} vào 10 · ${stats.quocGia} THPT · ${stats.lop6} vào 6 · ${stats.chinhKhoa} chính khoá` },
            { label: 'Nhiệm vụ', value: '3.000', sub: 'mỗi nhiệm vụ có KPI và điều kiện mở khoá' },
      ...
      <section>
        <SectionTitle
          ...
          desc="Ngoài 3.000 phiếu luyện theo chuyên đề, hệ thống có các đề mẫu hoàn chỉnh dựng đúng cấu trúc thật — đủ số bài, đúng thang điểm, đúng thời gian — kèm lời giải từng bước, barem chấm tới từng 0,25 điểm và bảng phân tích chi tiết cho mọi câu."
          right={
