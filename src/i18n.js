...
G.UI = {
  vi:{
    ...
    loginHint:'Chưa biết mật khẩu? Bấm thẳng vào một vai ở trên là vào được ngay, không cần mật khẩu. Hoặc mở danh sách để xem đủ tài khoản và mật khẩu.',
  ...
  en:{
    ...
    loginHint:'Don\u2019t know the password? Click any role above to enter straight away \u2014 no password needed. Or open the list to see every account and password.',
