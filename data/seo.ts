...
const T: [string, string, string, string, string[], number][] = [
  ...
  ['thithu', 'thi-thu-bam-gio', 'Thi thử bấm giờ trên đề trọn vẹn, chấm điểm ngay',
   'Bốn đề đủ độ dài thật, đồng hồ đếm ngược theo thời gian ngoài đời, nộp bài là có điểm từng phần và lời giải cho mọi câu làm sai.',
   ['thi thử tiếng anh online có chấm điểm', 'làm đề thi thử vào 10 môn tiếng anh'], 1.0],
