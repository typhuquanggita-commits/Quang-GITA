...
const MONG: {tab: RegExp; don: RegExp; that: number; nguon: string}[] = [
  ...
  {tab: /^Đề thi mẫu$/, don: /^đề$/i, that: DDe.DETHI_SO.soDe, nguon: 'DETHI_SO.soDe'},
  {tab: /^Đề thi mẫu$/, don: /^lời$/i, that: DDe.DETHI_SO.soLoiGiai, nguon: 'DETHI_SO.soLoiGiai'},
  {tab: /Thi thử/, don: /^đề$/i, that: DDe.DETHI_SO.soDe, nguon: 'DETHI_SO.soDe'},
  {tab: /Thi thử/, don: /^câu$/i, that: DDe.DETHI_SO.soCau, nguon: 'DETHI_SO.soCau'},
