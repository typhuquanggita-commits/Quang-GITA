...
ten: "Nhân và chia số có nhiều chữ số — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK1"
tuan: 11
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T1-L4-C06-HD
...
```
CỤM C06 — Nhân và chia số có nhiều chữ số
├── Nhân một số với một tổng, với một hiệu
├── Nhân với số có hai chữ số, ba chữ số
├── Chia cho số có một chữ số
├── Chia một tổng cho một số; chia cho số có hai chữ số
└── Chia cho số có ba chữ số
```

| Buổi | Loại phiếu | Mã phiếu | Sản phẩm phải có sau buổi |
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T1-L4-C06-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T1-L4-C06-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T1-L4-C06-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T1-L4-C06-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T1-L4-C06-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T1-L4-C06-TH` | Điểm bài thi chương |
...
| 3 | Làm lại phiếu `GITA-T1-L4-C06-NC` phần IV và V, chấm bằng phiếu `GITA-T1-L4-C06-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T1-L4-C06-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T1-L4-C06-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T1-L4-C06-NC`** và làm bài tương tự trong phiếu `GITA-T1-L4-C06-NC-GP`, chưa mở cụm mới.
