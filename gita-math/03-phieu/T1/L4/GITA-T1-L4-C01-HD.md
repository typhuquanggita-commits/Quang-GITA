...
ten: "Số tự nhiên: hàng, lớp và cấu tạo số — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK1"
tuan: 1
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T1-L4-C01-HD
...
```
CỤM C01 — Số tự nhiên: hàng, lớp và cấu tạo số
├── Ôn tập số tự nhiên: đọc, viết, so sánh đến lớp nghìn
├── Hàng và lớp — lớp nghìn, lớp triệu
├── Viết số tự nhiên trong hệ thập phân — dãy số tự nhiên
├── So sánh và xếp thứ tự số tự nhiên nhiều chữ số
└── Bài toán về cấu tạo số tự nhiên
```

| Buổi | Loại phiếu | Mã phiếu | Sản phẩm phải có sau buổi |
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T1-L4-C01-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T1-L4-C01-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T1-L4-C01-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T1-L4-C01-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T1-L4-C01-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T1-L4-C01-TH` | Điểm bài thi chương |
...
|---:|---|---|
| 1 | Xác định chữ số và giá trị chữ số theo hàng | Cấu tạo thập phân của số tự nhiên |
| 2 | Kiểm tra chia hết bằng dấu hiệu | Dấu hiệu chia hết cho 2, 3, 5, 9 |
| 3 | Biến đổi số bằng cách thêm, bớt, đổi chỗ chữ số | Cấu tạo thập phân, hiệu hai số |
...
| 7 | Đếm số chia hết đồng thời cho nhiều số | Bội chung nhỏ nhất, dãy số cách đều |
| 8 | Dãy số tự nhiên liên tiếp có tổng cho trước | Trung bình cộng, dãy cách đều |
| 9 | Phép chia có dư | Quan hệ giữa số bị chia, số chia, thương và số dư |
| 10 | Lập số và đếm số lập được từ một bộ chữ số | Quy tắc nhân trong phép đếm, điều kiện chữ số đứng đầu |
| 11 | So sánh hai số tự nhiên | Thứ tự trong tập số tự nhiên |
| 12 | Số và tổng chữ số của nó | Cấu tạo thập phân, phép chia có dư |
| 13 | Đếm số hạng của dãy cách đều theo điều kiện chia hết | Dãy số cách đều, dấu hiệu chia hết |
...
| 3 | Làm lại phiếu `GITA-T1-L4-C01-NC` phần IV và V, chấm bằng phiếu `GITA-T1-L4-C01-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T1-L4-C01-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
- [ ] **1.** Em nêu được dấu hiệu nhận biết của dạng “Xác định chữ số và giá trị chữ số theo hàng” chứ?
...
- [ ] **11.** Em nêu được dấu hiệu nhận biết của dạng “Nhận biết số nguyên tố, hợp số” chứ?
- [ ] **12.** Em nhớ công thức: Định nghĩa số nguyên tố, dấu hiệu chia hết?
...
- [ ] **15.** Em nêu được dấu hiệu nhận biết của dạng “Đếm số chia hết đồng thời cho nhiều số” chứ?
- [ ] **16.** Em nhớ công thức: Bội chung nhỏ nhất, dãy số cách đều?
...
|---:|---|---|
| 1 | Đếm hàng từ trái sang phải nên lệch hàng. | Luôn viết số ra nháp rồi đánh dấu hàng đơn vị trước, đi ngược về trái. |
| 2 | Bỏ qua hàng khuyết nên số viết ra bị ngắn đi một chữ số. | Kẻ sẵn các ô hàng rồi mới điền chữ số vào ô tương ứng. |
| 3 | Dùng dấu hiệu của 3 để kết luận cho 2, hoặc cộng thiếu một chữ số. | Viết rõ tổng các chữ số ra bên cạnh trước khi kết luận. |
...
| 6 | Thử chia cho mọi số từ 2 đến số đó nên mất thời gian, hoặc kết luận vội. | Thử theo thứ tự 2, 3, 5, 7, 11, 13 và dừng đúng lúc. |
| 7 | Nhầm “liền trước” với “bé hơn”, trả lời một số bất kì bé hơn. | Liền trước – liền sau chỉ hơn kém đúng **1** đơn vị. |
| 8 | Lấy tích hai số làm khoảng cách (ví dụ dùng 27 cho “chia hết cho 3 và 9”). | Kiểm tra bằng cách viết ba số đầu tiên của dãy rồi xem khoảng cách thật. |
...
| 12 | So từ hàng đơn vị (phải sang trái) nên kết luận sai. | Gạch chân cặp chữ số khác nhau đầu tiên tính từ bên trái. |
...
| 14 | Lấy luôn hai đầu khoảng làm số đầu và số cuối của dãy dù chúng không thoả điều kiện. | Viết ra ba số đầu và ba số cuối của dãy trước khi áp công thức. |
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T1-L4-C01-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T1-L4-C01-NC`** và làm bài tương tự trong phiếu `GITA-T1-L4-C01-NC-GP`, chưa mở cụm mới.
