...
ten: "Đơn vị đo độ dài, khối lượng, diện tích, thể tích và thời gian — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK1"
tuan: 3
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T1-L5-C02-HD
...
```
CỤM C02 — Đơn vị đo độ dài, khối lượng, diện tích, thể tích và thời gian
...
├── Bảng đơn vị đo thể tích: cm³, dm³, m³
└── Bảng đơn vị đo thời gian — cộng, trừ số đo thời gian
```

| Buổi | Loại phiếu | Mã phiếu | Sản phẩm phải có sau buổi |
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T1-L5-C02-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T1-L5-C02-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T1-L5-C02-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T1-L5-C02-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T1-L5-C02-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T1-L5-C02-TH` | Điểm bài thi chương |
...
| 3 | Làm lại phiếu `GITA-T1-L5-C02-NC` phần IV và V, chấm bằng phiếu `GITA-T1-L5-C02-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T1-L5-C02-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
- [ ] **1.** Em nêu được dấu hiệu nhận biết của dạng “Đổi đơn vị diện tích” chứ?
- [ ] **2.** Em nhớ công thức: Bảng đơn vị đo diện tích?
- [ ] **3.** Em nêu được dấu hiệu nhận biết của dạng “Tính thời điểm trong ngày” chứ?
...
- [ ] **18.** Em nhớ công thức: Nhân, chia số tự nhiên; đổi đơn vị khối lượng?
- [ ] **19.** Em nêu được dấu hiệu nhận biết của dạng “Đổi đơn vị đo” chứ?
- [ ] **20.** Em nhớ công thức: Bảng đơn vị đo độ dài, khối lượng?
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T1-L5-C02-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T1-L5-C02-NC`** và làm bài tương tự trong phiếu `GITA-T1-L5-C02-NC-GP`, chưa mở cụm mới.
