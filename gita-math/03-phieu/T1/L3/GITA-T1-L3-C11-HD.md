...
|---:|---|---|
| 1 | Đếm số hạng dãy cách đều theo điều kiện | Dãy cách đều, dấu hiệu chia hết |
...
| 7 | Bài toán trồng cây | Quan hệ số cây – số khoảng |
...
- [ ] **1.** Em nêu được dấu hiệu nhận biết của dạng “Đếm số hạng dãy cách đều theo điều kiện” chứ?
- [ ] **2.** Em nhớ công thức: Dãy cách đều, dấu hiệu chia hết?
...
- [ ] **11.** Em nêu được dấu hiệu nhận biết của dạng “Quy luật hình đưa về dãy số” chứ?
- [ ] **12.** Em nhớ công thức: Dãy cách đều, số hạng thứ n?
- [ ] **13.** Em nêu được dấu hiệu nhận biết của dạng “Tìm quy luật dãy cách đều” chứ?
- [ ] **14.** Em nhớ công thức: Dãy số cách đều?
- [ ] **15.** Em nêu được dấu hiệu nhận biết của dạng “Dãy tuần hoàn” chứ?
- [ ] **16.** Em nhớ công thức: Phép chia có dư, tính tuần hoàn?
- [ ] **17.** Em nêu được dấu hiệu nhận biết của dạng “Bài toán trồng cây” chứ?
- [ ] **18.** Em nhớ công thức: Quan hệ số cây – số khoảng?
...
|---:|---|---|
| 1 | Lấy luôn hai đầu khoảng làm số đầu và số cuối của dãy. | Viết ba số đầu và ba số cuối của dãy trước khi áp công thức. |
...
| 6 | Nhân khoảng cách với n nên thừa đúng một khoảng. | Kiểm chứng công thức với hình thứ 2 trước khi dùng cho hình thứ n. |
| 7 | Chỉ xét hai số đầu rồi vội kết luận. | Viết hiệu giữa các số hạng ngay dưới dấu ngoặc giữa chúng. |
| 8 | Dư 0 mà lấy phần tử đầu tiên. | Kiểm chứng với một vị trí nhỏ đã biết trước khi làm vị trí lớn. |
| 9 | Máy móc cộng 1 cho mọi trường hợp. | Vẽ một hình nhỏ với ba khoảng để đếm thử. |
