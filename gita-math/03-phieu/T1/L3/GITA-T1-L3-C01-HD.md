...
ten: "Bảng nhân, bảng chia và bốn phép tính nền tảng — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK1"
tuan: 1
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T1-L3-C01-HD
...
```
CỤM C01 — Bảng nhân, bảng chia và bốn phép tính nền tảng
├── Ôn tập cộng, trừ trong phạm vi 1000 — đặt tính và tính nhẩm
├── Bảng nhân, bảng chia 2 – 5: thuộc có hệ thống và vận dụng
├── Bảng nhân, bảng chia 6 và 7
├── Bảng nhân, bảng chia 8 và 9
...
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T1-L3-C01-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T1-L3-C01-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T1-L3-C01-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T1-L3-C01-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T1-L3-C01-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T1-L3-C01-TH` | Điểm bài thi chương |
...
| 2 | Nhân, chia số tự nhiên | Kĩ thuật đặt tính nhân, chia |
| 3 | Tìm x hai bước | Quan hệ các thành phần của phép tính |
| 4 | Tính giá trị biểu thức | Thứ tự thực hiện các phép tính |
| 5 | Tính nhanh biểu thức đơn giản | Tính chất giao hoán, kết hợp; nhân với 0 |
| 6 | Tính nhanh tổng nhiều số hạng | Tính chất giao hoán, kết hợp của phép cộng |
...
| 10 | Tổng dãy số tự nhiên liên tiếp | Ghép cặp, tổng dãy cách đều |
...
| 3 | Làm lại phiếu `GITA-T1-L3-C01-NC` phần IV và V, chấm bằng phiếu `GITA-T1-L3-C01-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T1-L3-C01-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
- [ ] **3.** Em nêu được dấu hiệu nhận biết của dạng “Nhân, chia số tự nhiên” chứ?
- [ ] **4.** Em nhớ công thức: Kĩ thuật đặt tính nhân, chia?
- [ ] **5.** Em nêu được dấu hiệu nhận biết của dạng “Nhân, chia với số có một chữ số” chứ?
- [ ] **6.** Em nhớ công thức: Kĩ thuật đặt tính nhân, chia?
- [ ] **7.** Em nêu được dấu hiệu nhận biết của dạng “Tìm x hai bước” chứ?
- [ ] **8.** Em nhớ công thức: Quan hệ các thành phần của phép tính?
- [ ] **9.** Em nêu được dấu hiệu nhận biết của dạng “Tính giá trị biểu thức” chứ?
- [ ] **10.** Em nhớ công thức: Thứ tự thực hiện các phép tính?
- [ ] **11.** Em nêu được dấu hiệu nhận biết của dạng “Tính nhanh biểu thức đơn giản” chứ?
- [ ] **12.** Em nhớ công thức: Tính chất giao hoán, kết hợp; nhân với 0?
- [ ] **13.** Em nêu được dấu hiệu nhận biết của dạng “Tính nhanh tổng nhiều số hạng” chứ?
- [ ] **14.** Em nhớ công thức: Tính chất giao hoán, kết hợp của phép cộng?
...
| 2 | Quên viết chữ số 0 ở thương nên thương thiếu chữ số. | Đếm số chữ số của thương trước khi chia để biết mình cần viết mấy chữ số. |
| 3 | Quên chữ số 0 ở giữa thương nên thương thiếu chữ số. | Đếm trước xem thương có mấy chữ số rồi mới chia. |
| 4 | Gỡ phép nhân trước khi gỡ phép cộng ở ngoài. | Khoanh tròn cụm chứa x rồi coi cả cụm là một số. |
| 5 | Cộng trước nhân khi biểu thức không có ngoặc. | Gạch chân phép nhân, phép chia trước khi tính. |
| 6 | Lao vào tính từ trái sang phải, bỏ lỡ mọi lối tắt. | Đọc hết biểu thức một lượt trước khi đặt bút. |
| 7 | Cộng lần lượt từ trái sang phải nên bỏ lỡ cặp số tròn. | Đọc lướt cả dãy, khoanh tròn cặp số cộng lại tròn chục, tròn trăm. |
...
| 11 | Cộng dồn từ đầu đến cuối, rất lâu và dễ sai. | Viết ra ba cặp đầu để thấy rõ các cặp có cùng tổng. |
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T1-L3-C01-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T1-L3-C01-NC`** và làm bài tương tự trong phiếu `GITA-T1-L3-C01-NC-GP`, chưa mở cụm mới.
