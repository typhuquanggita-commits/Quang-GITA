...
ten: "Tính chất phép nhân, chữ số tận cùng và tổng ôn số học — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK2"
tuan: 32
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T1-L3-C16-HD
...
```
CỤM C16 — Tính chất phép nhân, chữ số tận cùng và tổng ôn số học
├── Tính chất phép nhân: giao hoán, kết hợp, nhân với 1 và 0
├── Chữ số tận cùng của một tích đơn giản
├── Bài toán về cấu tạo số có ba chữ số
└── Ôn tập số học lớp 3
```

| Buổi | Loại phiếu | Mã phiếu | Sản phẩm phải có sau buổi |
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T1-L3-C16-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T1-L3-C16-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T1-L3-C16-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T1-L3-C16-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T1-L3-C16-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T1-L3-C16-TH` | Điểm bài thi chương |
...
| 3 | Đếm chữ số theo nhóm | Đếm số hạng, cấu tạo số |
| 4 | Lập số từ bộ chữ số | Cấu tạo số có ba chữ số |
| 5 | Đọc, viết, cấu tạo số | Cấu tạo thập phân của số tự nhiên |
| 6 | Đếm số thoả điều kiện về chữ số | Cấu tạo số, tổng chữ số, quy tắc đếm |
| 7 | So sánh hai số tự nhiên | Thứ tự trong tập số tự nhiên |
| 8 | Tìm thành phần chưa biết; tính chất phép nhân | Quan hệ các thành phần phép tính; giao hoán, kết hợp, nhân 0 và 1 |
| 9 | Nhận biết chẵn – lẻ và số liền kề | Dãy số tự nhiên liên tiếp, dấu hiệu chia hết cho 2 |
| 10 | Đổi chỗ chữ số | Cấu tạo số có hai chữ số |
| 11 | Chữ số tận cùng | Tính chất chữ số tận cùng của tổng, tích |
| 12 | Phép chia có dư | Quan hệ giữa số bị chia, số chia, thương và số dư |
...
| 3 | Làm lại phiếu `GITA-T1-L3-C16-NC` phần IV và V, chấm bằng phiếu `GITA-T1-L3-C16-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T1-L3-C16-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
- [ ] **3.** Em nêu được dấu hiệu nhận biết của dạng “Kiểm tra chia hết bằng dấu hiệu” chứ?
- [ ] **4.** Em nhớ công thức: Dấu hiệu chia hết cho 2, 3, 5, 9?
- [ ] **5.** Em nêu được dấu hiệu nhận biết của dạng “Đếm chữ số theo nhóm” chứ?
- [ ] **6.** Em nhớ công thức: Đếm số hạng, cấu tạo số?
- [ ] **7.** Em nêu được dấu hiệu nhận biết của dạng “Lập số từ bộ chữ số” chứ?
- [ ] **8.** Em nhớ công thức: Cấu tạo số có ba chữ số?
- [ ] **9.** Em nêu được dấu hiệu nhận biết của dạng “Đọc, viết, cấu tạo số” chứ?
- [ ] **10.** Em nhớ công thức: Cấu tạo thập phân của số tự nhiên?
- [ ] **11.** Em nêu được dấu hiệu nhận biết của dạng “Đếm số thoả điều kiện về chữ số” chứ?
- [ ] **12.** Em nhớ công thức: Cấu tạo số, tổng chữ số, quy tắc đếm?
- [ ] **13.** Em nêu được dấu hiệu nhận biết của dạng “So sánh hai số tự nhiên” chứ?
- [ ] **14.** Em nhớ công thức: Thứ tự trong tập số tự nhiên?
- [ ] **15.** Em nêu được dấu hiệu nhận biết của dạng “Tìm thành phần chưa biết; tính chất phép nhân” chứ?
- [ ] **16.** Em nhớ công thức: Quan hệ các thành phần phép tính; giao hoán, kết hợp, nhân 0 và 1?
- [ ] **17.** Em nêu được dấu hiệu nhận biết của dạng “Nhận biết chẵn – lẻ và số liền kề” chứ?
- [ ] **18.** Em nhớ công thức: Dãy số tự nhiên liên tiếp, dấu hiệu chia hết cho 2?
...
| 2 | Dùng dấu hiệu của 3 để kết luận cho 2. | Ghi tổng các chữ số ra bên cạnh trước khi kết luận. |
| 3 | Lấy số trang nhân với 2 hoặc 3 cho toàn bộ. | Kẻ bảng: khoảng trang – số trang – số chữ số. |
| 4 | Viết lộn xộn nên vừa sót vừa trùng. | Cố định chữ số hàng trăm rồi mới đổi chỗ hai chữ số còn lại. |
| 5 | Đếm hàng từ trái sang phải nên lệch hàng. | Đánh dấu hàng đơn vị trước, rồi đi ngược về bên trái. |
| 6 | Viết lộn xộn nên vừa sót vừa lặp; hoặc quên điều kiện ba chữ số khác nhau. | Kẻ bảng theo chữ số hàng trăm tăng dần. |
| 7 | So từ hàng đơn vị (phải sang trái) nên kết luận sai. | Gạch chân cặp chữ số khác nhau đầu tiên tính từ bên trái. |
| 8 | Áp dụng quy tắc của số trừ cho số bị trừ. | Viết ra vai trò của x trước khi viết phép tính. |
| 9 | Nhầm “liền trước” với “bé hơn”, trả lời một số bất kì bé hơn. | Liền trước – liền sau chỉ hơn kém đúng **1** đơn vị. |
| 10 | Coi hiệu hai số bằng hiệu hai chữ số. | Tính thử vài trường hợp nhỏ để thấy quy luật nhân 9. |
| 11 | Nhầm “thêm bên trái” thành “thêm bên phải”. | Viết cả hai số ra giấy rồi mới so sánh. |
| 12 | Tính trọn cả phép tính, vừa lâu vừa dễ sai. | Lấy tay che phần đầu của hai số, chỉ để lộ chữ số cuối. |
| 13 | Để số dư lớn hơn số chia, hoặc quên hạ chữ số 0 nên thương thiếu chữ số. | Thử lại bằng công thức số bị chia = số chia × thương + số dư. |
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T1-L3-C16-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T1-L3-C16-NC`** và làm bài tương tự trong phiếu `GITA-T1-L3-C16-NC-GP`, chưa mở cụm mới.
