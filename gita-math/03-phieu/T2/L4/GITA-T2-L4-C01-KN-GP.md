...
- **Bài B.2** — a) “Nhận biết số nguyên tố, hợp số là:” · b) “Lập số và đếm số lập được từ một bộ chữ số là:” · c) “Đếm chữ số, tính tổng chữ số là:” · d) “Viết số từ dạng tổng theo hàng là:” · e) “Số và tổng chữ số của nó là:”
...
- **Bài B.4** — a) Thử theo thứ tự 2, 3, 5, 7, 11, 13 và dừng đúng lúc. · b) Liệt kê theo nhóm: cố định hàng trăm rồi mới hoán vị hai chữ số còn lại. · c) Viết rời từng chữ số ra rồi mới cộng. · d) Kẻ sẵn các ô hàng rồi mới điền chữ số vào ô tương ứng. · e) Kiểm tra lại đáp số bằng cách thay ngược vào đề. · f) Viết cả số cũ và số mới ra rồi mới so sánh.
...
- **Bài C.4** — a) tầng 2 · b) Kẻ bảng ba cột: khoảng trang – số trang – số chữ số, rồi cộng cột cuối. · c) toàn bộ số điểm của ý sai · d) Kẻ bảng ba cột: khoảng trang – số trang – số chữ số, rồi cộng cột cuối. · e) Nhóm cuối cùng thường **không đầy đủ** — phải đếm đúng số trang còn lại.
...
- **Bài D.4** — a) Đề nói “xoá chữ số”, “viết thêm chữ số”, “đổi chỗ” · b) Viết cả hai số theo cấu tạo rồi lấy hiệu · c) Nhầm “viết thêm bên trái” thành “viết thêm bên phải”. · d) Cấu tạo thập phân, hiệu hai số · e) Đổi chỗ hàng trăm với hàng đơn vị: hiệu = 99 × (hiệu hai chữ số).
...
### Bài D.2 — Nhánh 1 — Lập số và đếm số lập được từ một bộ chữ số
...
### Bài D.4 — Nhánh 3 — Biến đổi số bằng cách thêm, bớt, đổi chỗ chữ số
...
### Bài E.3 — Nội dung giảng — Đếm chữ số, tính tổng chữ số
...
### Bài E.4 — Nội dung giảng — Số và tổng chữ số của nó
...
### Bài E.5 — Nội dung giảng — Đếm chữ số theo nhóm độ dài
...
| B.2 | Kỹ năng viết câu lời giải | Chuẩn trình bày | Đề hỏi gì thì câu lời giải nhắc lại điều đó | Lấy cụm từ trong câu hỏi làm câu lời giải | Sao chép cụm từ trong câu hỏi là cách viết câu lời giải nhanh và chắc nhất. | “Nhận biết số nguyên tố, hợp số là:” · “Lập số và đếm số lập được từ một bộ chữ số là:” · “Đếm chữ số, tính tổng chữ số là:” · “Viết số từ dạng tổng theo hàng là:”… |
...
| B.4 | Sổ lỗi và cách phòng | Lỗi thường gặp của chương | Cột “Lỗi thường gặp” trong bảng phân tích | Ghép cặp lỗi với cách phòng | Đọc lại sổ lỗi 3 phút trước mỗi bài kiểm tra. | Thử theo thứ tự 2, 3, 5, 7, 11, 13 và dừng đúng lúc. · Liệt kê theo nhóm: cố định hàng trăm rồi mới hoán vị hai chữ số còn lại. · Viết rời từng chữ số ra rồi mới cộng. · Kẻ sẵn các ô hàng rồi mới điền chữ số vào ô tương ứng.… |
...
| C.4 | TD4, TD6 | Nhóm cuối cùng thường **không đầy đủ** — phải đếm đúng số trang còn lại. |
...
| E.3 | TD1 | Tổng các chữ số **không** phụ thuộc thứ tự các chữ số. |
| E.4 | TD3, TD6 | Khi ẩn chỉ nhận hữu hạn giá trị, **lập bảng** là phương pháp chắc chắn nhất. |
| E.5 | TD4, TD6 | Nhóm cuối cùng thường **không đầy đủ** — phải đếm đúng số trang còn lại. |
...
| C.4 | Lấy số trang nhân với số chữ số của trang cuối. | Kẻ bảng ba cột: khoảng trang – số trang – số chữ số, rồi cộng cột cuối. |
...
| E.4 | Chia bừa mà không kiểm tra điều kiện chia hết nên nhận đáp số không nguyên. | Kiểm tra lại đáp số bằng cách thay ngược vào đề. |
| E.5 | Lấy số trang nhân với số chữ số của trang cuối. | Kẻ bảng ba cột: khoảng trang – số trang – số chữ số, rồi cộng cột cuối. |
...
| C.4 | Quyển sách 150 trang dùng hết bao nhiêu chữ số? | 342 |
...
| D.5 | Chữ số hàng chục của số 948 793 có giá trị bao nhiêu? | 90 |
...
| E.5 | Quyển sách 150 trang dùng hết bao nhiêu chữ số? | 342 |
