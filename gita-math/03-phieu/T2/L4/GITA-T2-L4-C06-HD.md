...
|---:|---|---|
| 1 | Tổng dãy cộng trừ xen kẽ | Ghép cặp, tính chất kết hợp |
| 2 | Cộng, trừ số tự nhiên | Kĩ thuật đặt tính, nhớ và mượn |
| 3 | Tìm x nhiều bước có ngoặc | Thứ tự thực hiện phép tính, quan hệ thành phần |
| 4 | Nhân một số với một tổng | Tính chất phân phối của phép nhân với phép cộng |
| 5 | Tính nhanh tích, thương nhiều bước | Tính chất giao hoán, kết hợp của phép nhân |
| 6 | Tính, so sánh tích bằng kĩ thuật tách – bù | Nhân một số với một tổng, một hiệu |
...
| 9 | Tính nhanh nhờ thừa số 0 | Tính chất nhân với 0, phép trừ hai số bằng nhau |
...
| 12 | Nhân, chia số tự nhiên | Kĩ thuật đặt tính nhân, chia |
| 13 | Tổng các tích có thừa số chung | Nhân một số với một tổng, tổng dãy cách đều |
...
- [ ] **1.** Em nêu được dấu hiệu nhận biết của dạng “Tổng dãy cộng trừ xen kẽ” chứ?
- [ ] **2.** Em nhớ công thức: Ghép cặp, tính chất kết hợp?
- [ ] **3.** Em nêu được dấu hiệu nhận biết của dạng “Cộng, trừ số tự nhiên” chứ?
- [ ] **4.** Em nhớ công thức: Kĩ thuật đặt tính, nhớ và mượn?
- [ ] **5.** Em nêu được dấu hiệu nhận biết của dạng “Tìm x nhiều bước có ngoặc” chứ?
- [ ] **6.** Em nhớ công thức: Thứ tự thực hiện phép tính, quan hệ thành phần?
- [ ] **7.** Em nêu được dấu hiệu nhận biết của dạng “Nhân một số với một tổng” chứ?
- [ ] **8.** Em nhớ công thức: Tính chất phân phối của phép nhân với phép cộng?
- [ ] **9.** Em nêu được dấu hiệu nhận biết của dạng “Tính nhanh tích, thương nhiều bước” chứ?
- [ ] **10.** Em nhớ công thức: Tính chất giao hoán, kết hợp của phép nhân?
- [ ] **11.** Em nêu được dấu hiệu nhận biết của dạng “Tính, so sánh tích bằng kĩ thuật tách – bù” chứ?
...
- [ ] **17.** Em nêu được dấu hiệu nhận biết của dạng “Tính nhanh nhờ thừa số 0” chứ?
- [ ] **18.** Em nhớ công thức: Tính chất nhân với 0, phép trừ hai số bằng nhau?
...
|---:|---|---|
| 1 | Ghép cặp nhưng quên số hạng lẻ còn thừa ở cuối. | Đếm số số hạng trước, xác định chẵn hay lẻ rồi mới ghép cặp. |
| 2 | Viết lệch hàng khi hai số có số chữ số khác nhau. | Kẻ cột dọc cho từng hàng trước khi viết số. |
| 3 | Nhân phá ngoặc sai dấu, hoặc gỡ phép trong ngoặc trước. | Ghi rõ từng bước trên một dòng riêng, mỗi dòng chỉ khác dòng trên một phép. |
| 4 | Nhân từng dòng rồi cộng, dài và dễ sai ở một dòng nào đó. | Nhìn cột đơn giá trước: có dòng nào trùng đơn giá không? |
| 5 | Nhân lần lượt từ trái sang phải nên số trung gian rất lớn. | Quét cả tích tìm cặp tròn trước khi đặt bút tính. |
| 6 | Nhân hết ra rồi mới so sánh — số lớn, dễ sai và mất thời gian. | Viết mỗi thừa số dưới dạng “số gốc cộng hoặc trừ mấy đơn vị”. |
...
| 9 | Lao vào nhân từng cặp số lớn rồi mới phát hiện kết quả bằng 0. | Đọc hết biểu thức một lượt, khoanh các cụm giống nhau bị trừ cho nhau. |
| 10 | Cộng lần lượt từ trái sang phải nên bỏ lỡ cặp số tròn. | Đọc lướt cả dãy, khoanh tròn cặp số cộng lại tròn chục, tròn trăm. |
| 11 | Tính hết cả hai vế, vừa lâu vừa dễ sai. | Dùng bút gạch bỏ phần giống nhau ở hai vế trước khi so sánh. |
...
| 13 | Nhân từng tích rồi cộng dồn, rất dài và dễ sai. | Viết lại biểu thức dưới dạng a × (1 + 2 + … + n) trước khi tính. |
| 14 | Nhân với 10 rồi quên cộng hoặc trừ phần bù. | Viết luôn dấu ± và số bù ra bên cạnh trước khi nhân. |
