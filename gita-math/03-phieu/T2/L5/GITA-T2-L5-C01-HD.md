...
|---:|---|---|
| 1 | Lập số và đếm số lập được từ một bộ chữ số | Quy tắc nhân trong phép đếm, điều kiện chữ số đứng đầu |
...
| 7 | Viết số từ dạng tổng theo hàng | Cấu tạo thập phân của số tự nhiên |
| 8 | Nhận biết chẵn – lẻ và số liền kề | Dãy số tự nhiên liên tiếp, dấu hiệu chia hết cho 2 |
| 9 | Dãy số tự nhiên liên tiếp có tổng cho trước | Trung bình cộng, dãy cách đều |
| 10 | So sánh hai số tự nhiên | Thứ tự trong tập số tự nhiên |
| 11 | Đếm số chia hết đồng thời cho nhiều số | Bội chung nhỏ nhất, dãy số cách đều |
| 12 | Tìm chữ số tận cùng của một phép tính | Tính chất chữ số tận cùng |
| 13 | Dùng chữ thay số kết hợp thử chọn | Cấu tạo thập phân; dấu hiệu chia hết; đếm có hệ thống |
| 14 | Biến đổi số bằng cách thêm, bớt, đổi chỗ chữ số | Cấu tạo thập phân, hiệu hai số |
...
- [ ] **1.** Em nêu được dấu hiệu nhận biết của dạng “Lập số và đếm số lập được từ một bộ chữ số” chứ?
- [ ] **2.** Em nhớ công thức: Quy tắc nhân trong phép đếm, điều kiện chữ số đứng đầu?
...
- [ ] **13.** Em nêu được dấu hiệu nhận biết của dạng “Viết số từ dạng tổng theo hàng” chứ?
- [ ] **14.** Em nhớ công thức: Cấu tạo thập phân của số tự nhiên?
- [ ] **15.** Em nêu được dấu hiệu nhận biết của dạng “Nhận biết chẵn – lẻ và số liền kề” chứ?
- [ ] **16.** Em nhớ công thức: Dãy số tự nhiên liên tiếp, dấu hiệu chia hết cho 2?
...
- [ ] **19.** Em nêu được dấu hiệu nhận biết của dạng “So sánh hai số tự nhiên” chứ?
- [ ] **20.** Em nhớ công thức: Thứ tự trong tập số tự nhiên?
...
|---:|---|---|
| 1 | Viết lộn xộn nên vừa sót vừa trùng; hoặc nhận cả số bắt đầu bằng 0. | Liệt kê theo nhóm: cố định hàng trăm rồi mới hoán vị hai chữ số còn lại. |
...
| 7 | Bỏ qua hàng khuyết nên số viết ra bị ngắn đi một chữ số. | Kẻ sẵn các ô hàng rồi mới điền chữ số vào ô tương ứng. |
| 8 | Nhầm “liền trước” với “bé hơn”, trả lời một số bất kì bé hơn. | Liền trước – liền sau chỉ hơn kém đúng **1** đơn vị. |
...
| 10 | So từ hàng đơn vị (phải sang trái) nên kết luận sai. | Gạch chân cặp chữ số khác nhau đầu tiên tính từ bên trái. |
| 11 | Lấy tích hai số làm khoảng cách (ví dụ dùng 27 cho “chia hết cho 3 và 9”). | Kiểm tra bằng cách viết ba số đầu tiên của dãy rồi xem khoảng cách thật. |
| 12 | Tính trọn cả phép tính, vừa lâu vừa dễ sai. | Che phần đầu của hai số, chỉ để lộ chữ số cuối cùng. |
| 13 | Thử luôn từ 100 đến 999, hết giờ mà chưa xong. | Trước khi thử, tự hỏi điều kiện nào cho ít khả năng nhất. |
| 14 | Nhầm “viết thêm bên trái” thành “viết thêm bên phải”. | Viết cả số cũ và số mới ra rồi mới so sánh. |
