...
ten: "Phân số ẩn, phần trăm trong biểu đồ và dạng đề chuyên — Phiếu Lý thuyết"
...
thang_diem: 100
muc_tieu_G: >
  Sau phiếu này em phát biểu lại được toàn bộ lý thuyết của chương **Phân số ẩn, phần
  trăm trong biểu đồ và dạng đề chuyên** và tự vẽ được sơ đồ tư duy chương mà không
  nhìn sách.
dong_luc_I: >
...
# PHIẾU HỌC GITA · GITA-T2-L5-C13-LT
...
**Cụm chuyên đề C13 — Phân số ẩn, phần trăm trong biểu đồ và dạng đề chuyên** · Buổi 1/6 · **Phiếu Lý thuyết**
...
Phiếu lời giải và phân tích chuyên sâu đi kèm: `GITA-T2-L5-C13-LT-GP`
...
a) Viết số gồm tổng: 4 000 000 + 200 000 + 8 000 + 700 + 20 + 6
b) Viết số gồm tổng: 1 000 000 + 300 000 + 30 000 + 700 + 40 + 9
c) Viết số gồm tổng: 1 000 000 + 100 000 + 60 000 + 9 000 + 600 + 20 + 1
d) Viết số gồm tổng: 9 000 000 + 700 000 + 90 000 + 1 000 + 400 + 10
e) Viết số gồm tổng: 5 000 000 + 100 000 + 20 000 + 8 000 + 500 + 60 + 5
...
a) Rút gọn phân số 16 phần 40.
b) Rút gọn phân số 24 phần 8.
c) Rút gọn phân số 3 phần 9.
d) Rút gọn phân số 42 phần 49.
e) Rút gọn phân số 4 phần 4.

### Bài 4. (1 điểm) Số thập phân: hàng, so sánh, đổi từ phân số

Chú ý dấu phẩy và các hàng sau dấu phẩy.

a) Viết phân số 30 phần 100 dưới dạng số thập phân.
b) Trong số 113,701, chữ số ở hàng phần mười là chữ số nào?
c) 837,899 … 836,089
d) Trong số 325,848, chữ số ở hàng phần mười là chữ số nào?
e) 395,631 … 396,887
f) Viết phân số 301 phần 1 000 dưới dạng số thập phân.
g) 397,501 … 397,319
...
a) 2 548 kg = … tấn … tạ … kg
b) 2 tấn 6 tạ 54 kg = … kg
c) 6 tấn 8 tạ 22 kg = … kg
d) 1 597 kg = … tấn … tạ … kg
e) 6 683 kg = … tấn … tạ … kg
f) 5 tấn 7 tạ 39 kg = … kg
...
Chương **Phân số ẩn, phần trăm trong biểu đồ và dạng đề chuyên** thuộc nhóm chuyên đề **H — Phân số – Số thập phân – Tỉ số phần trăm – Thống kê**.
...
a) Nêu một dấu hiệu nhận biết của dạng “Tỉ số phần trăm trong mua bán”.
b) Nêu một dấu hiệu nhận biết của dạng “Ba dạng toán tỉ số phần trăm”.
c) Nêu một dấu hiệu nhận biết của dạng “Phần trăm thay đổi nhiều lần”.
...
a) Công thức hoặc quy tắc dùng cho dạng “Tỉ số phần trăm trong mua bán”?
b) Công thức hoặc quy tắc dùng cho dạng “Ba dạng toán tỉ số phần trăm”?
c) Công thức hoặc quy tắc dùng cho dạng “Phần trăm thay đổi nhiều lần”?
...
a) Dạng “Tỉ số phần trăm trong mua bán” nên minh hoạ bằng hình vẽ hay bằng bảng?
b) Dạng “Ba dạng toán tỉ số phần trăm” nên minh hoạ bằng hình vẽ hay bằng bảng?
c) Dạng “Phần trăm thay đổi nhiều lần” nên minh hoạ bằng hình vẽ hay bằng bảng?
...
a) Dấu hiệu nào cho biết đề thuộc dạng “Tỉ số phần trăm trong mua bán”?
b) Dấu hiệu nào cho biết đề thuộc dạng “Ba dạng toán tỉ số phần trăm”?
c) Dấu hiệu nào cho biết đề thuộc dạng “Phần trăm thay đổi nhiều lần”?
...
a) Cách xử lý nhanh nhất của dạng “Tỉ số phần trăm trong mua bán” là gì?
b) Cách xử lý nhanh nhất của dạng “Ba dạng toán tỉ số phần trăm” là gì?
c) Cách xử lý nhanh nhất của dạng “Phần trăm thay đổi nhiều lần” là gì?
...
### Bài 1. (6 điểm) Key 1 — Tỉ số phần trăm trong mua bán
...
### Bài 3. (6 điểm) Key 3 — Phần trăm thay đổi nhiều lần
...
a) Trung bình mỗi ngày bán được 82 kg gạo. Hỏi 6 ngày bán được tất cả bao nhiêu ki-lô-gam?
b) Trung bình mỗi ngày bán được 266 kg gạo. Hỏi 3 ngày bán được tất cả bao nhiêu ki-lô-gam?
c) Trung bình mỗi ngày bán được 208 kg gạo. Hỏi 3 ngày bán được tất cả bao nhiêu ki-lô-gam?
d) Trung bình mỗi ngày bán được 252 kg gạo. Hỏi 3 ngày bán được tất cả bao nhiêu ki-lô-gam?
e) Trung bình mỗi ngày cửa hàng bán được 106 kg gạo. 3 ngày đầu bán được 108, 118, 97 kg. Ngày cuối bán được bao nhiêu ki-lô-gam?

### Bài 2. (8 điểm) Bốn phép tính với phân số

Tính rồi rút gọn kết quả.

a) 11 phần 10 : 1 phần 2
b) 2 − 1
c) 12 phần 11 × 1
d) 1 + 3 phần 10
e) 1 − 1
...
a) Biết 75% của một số là 300. Tìm số đó.
b) Tìm 30% của 200.
c) Tìm tỉ số phần trăm của 240 và 400.
d) Tìm tỉ số phần trăm của 2 và 40.
e) Tìm 5% của 20.
f) Biết 60% của một số là 12. Tìm số đó.
g) Tìm tỉ số phần trăm của 3 và 20.
...
a) Hai lớp 4B và 4C có tất cả 346 quyển sách. Lớp 4B có nhiều hơn lớp 4C 88 quyển. Mỗi lớp có bao nhiêu quyển?
b) Nhóm Sao Mai và tổ Một trồng được 162 cây. Nhóm Sao Mai trồng nhiều hơn tổ Một 42 cây. Mỗi tổ trồng bao nhiêu cây?
c) Kho A và kho B chứa tất cả 382 kg thóc. Kho A chứa nhiều hơn kho B 88 kg. Mỗi nơi chứa bao nhiêu kg?
d) Trang trại và cửa hàng chứa tất cả 484 kg đường. Trang trại chứa nhiều hơn cửa hàng 52 kg. Mỗi nơi chứa bao nhiêu kg?
...
### Bài A.1
**Đáp số:** a) 4 208 726 · b) 1 330 749 · c) 1 169 621 · d) 9 791 410 · e) 5 128 565
...
### Bài A.3
**Đáp số:** a) 2 phần 5 · b) 3 · c) 1 phần 3 · d) 6 phần 7 · e) 1
...
### Bài A.5
**Đáp số:** a) 2 tấn 5 tạ 48 kg · b) 2 654 · c) 6 822 · d) 1 tấn 5 tạ 97 kg · e) 6 tấn 6 tạ 83 kg · f) 5 739
...
### Bài B.1
**Đáp số:** a) Phân số ẩn, phần trăm trong biểu đồ và dạng đề chuyên · b) H — Phân số – Số thập phân – Tỉ số phần trăm – Thống kê · c) 4 · d) ở mọi bài thuộc phân số – số thập phân – tỉ số phần trăm – thống kê, vì các chương sau đều dùng lại nền này · e) giải nhanh và chắc các bài bài toán về phân số ẩn trong bài toán có lời văn
...
### Bài B.4
**Đáp số:** a) Từ khoá “tăng giá”, “giảm giá”, “lãi”, “lỗ” · b) Kí hiệu %, cụm “… % của …” · c) Hai lần tăng giảm liên tiếp · d) Cụm “chiếm bao nhiêu phần trăm”, “so với cả lớp” · e) Biểu thức chỉ gồm phân số · f) Tử và mẫu hơn kém nhau đúng 1 đơn vị; hoặc hai phân số nằm hai bên 1 phần 2
...
### Bài C.1
**Đáp số:** a) Phân số ẩn, phần trăm trong biểu đồ và dạng đề chuyên · b) H — Phân số – Số thập phân – Tỉ số phần trăm – Thống kê · c) 4 · d) Bài toán về phân số ẩn trong bài toán có lời văn · e) Tổng ôn phân số, số thập phân và phần trăm nâng cao
...
### Bài C.2
**Đáp số:** a) Tỉ số phần trăm, tăng giảm theo phần trăm · b) Tỉ số phần trăm · c) Tỉ số phần trăm, mốc quy chiếu · d) Tỉ số phần trăm · e) Quy đồng, nhân chia phân số · f) Phần bù tới 1, phân số trung gian
...
### Bài C.3
**Đáp số:** a) Chốt mốc 100% rồi cộng trừ phần trăm · b) Xác định đại lượng ứng với 100% rồi chọn dạng · c) Tính tuần tự, xác định lại mốc 100% sau mỗi bước · d) Chốt đại lượng 100% rồi chọn dạng · e) Chọn quy tắc theo phép tính, rút gọn cuối cùng
...
### Bài C.5
**Đáp số:** a) Giảm 20% nghĩa là còn 80% — nhân thẳng một lần thay vì trừ hai bước. · b) Coi 100% là “cả phần”, 1% là “cả phần chia 100” — mọi dạng đều quy về 1%. · c) Tăng 20% rồi giảm 20% thì còn 96% giá ban đầu — luôn thấp hơn giá cũ. · d) Nếu tỉ số là 1 phần 4 thì bằng 25%; nhớ vài mốc quen để nhẩm. · e) Rút gọn chéo trước khi nhân để số nhỏ, tính nhanh và ít sai. · f) Phân số dạng n phần (n + 1) càng có n lớn thì càng gần 1, tức càng lớn.
...
### Bài E.1
**Đáp số:** a) 492 kg · b) 798 kg · c) 624 kg · d) 756 kg · e) 101 kg
...
### Bài E.2
**Đáp số:** a) 11 phần 5 · b) 1 · c) 12 phần 11 · d) 13 phần 10 · e) 0
...
### Bài E.3
**Đáp số:** a) 400 · b) 60 · c) 60% · d) 5% · e) 1 · f) 20 · g) 15%
...
### Bài E.4
**Đáp số:** a) 19,66 · b) 93,27 · c) 254,82 · d) 7,42 · e) 47,97 · f) 52,38 · g) 293,88
...
### Bài E.5
**Đáp số:** a) 4B: 217 quyển, 4C: 129 quyển · b) nhóm Sao Mai: 102 cây, tổ Một: 60 cây · c) kho A: 235 kg, kho B: 147 kg · d) trang trại: 268 kg, cửa hàng: 216 kg
