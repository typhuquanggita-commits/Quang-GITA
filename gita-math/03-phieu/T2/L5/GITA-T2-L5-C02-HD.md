...
|---:|---|---|
| 1 | Bốn phép tính với số thập phân | Kĩ thuật tính với số thập phân |
...
| 5 | Số thập phân — hàng, so sánh, chuyển đổi | Cấu tạo số thập phân, quan hệ phân số – số thập phân |
...
| 10 | Ba dạng toán tỉ số phần trăm | Tỉ số phần trăm |
| 11 | Tìm phân số của một số | Nhân số tự nhiên với phân số |
...
- [ ] **1.** Em nêu được dấu hiệu nhận biết của dạng “Bốn phép tính với số thập phân” chứ?
- [ ] **2.** Em nhớ công thức: Kĩ thuật tính với số thập phân?
...
- [ ] **9.** Em nêu được dấu hiệu nhận biết của dạng “Số thập phân — hàng, so sánh, chuyển đổi” chứ?
- [ ] **10.** Em nhớ công thức: Cấu tạo số thập phân, quan hệ phân số – số thập phân?
...
|---:|---|---|
| 1 | Nhân xong đặt dấu phẩy thẳng cột như phép cộng. | Đếm số chữ số sau dấu phẩy ngay khi viết đề bài. |
...
| 5 | Cho rằng số có nhiều chữ số sau dấu phẩy hơn thì lớn hơn. | Viết thêm chữ số 0 vào cuối để hai số có cùng số chữ số thập phân rồi mới so. |
