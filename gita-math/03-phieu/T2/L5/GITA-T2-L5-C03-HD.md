...
| 5 | Dãy số theo quy luật nhân | Dãy nhân, phép nhân liên tiếp |
| 6 | Dãy có hiệu tăng đều (hiệu bậc hai) | Dãy hiệu, tổng dãy cách đều |
...
| 11 | Bài toán trồng cây | Quan hệ số cây – số khoảng |
| 12 | Dãy tuần hoàn | Phép chia có dư, tính tuần hoàn |
| 13 | Tìm quy luật dãy cách đều | Dãy số cách đều |
| 14 | Dãy số truy hồi có quy tắc rẽ nhánh | Dãy số cho bởi quy tắc, tính lần lượt |
...
- [ ] **9.** Em nêu được dấu hiệu nhận biết của dạng “Dãy số theo quy luật nhân” chứ?
- [ ] **10.** Em nhớ công thức: Dãy nhân, phép nhân liên tiếp?
- [ ] **11.** Em nêu được dấu hiệu nhận biết của dạng “Dãy có hiệu tăng đều (hiệu bậc hai)” chứ?
- [ ] **12.** Em nhớ công thức: Dãy hiệu, tổng dãy cách đều?
...
| 5 | Cố ép dãy nhân thành dãy cộng nên tìm ra quy luật sai. | Thử cả hai: hiệu trước, thương sau. |
| 6 | Cộng n hiệu thay vì (n − 1) hiệu. | Kiểm chứng với n = 2: chỉ cộng đúng một hiệu. |
...
| 11 | Máy móc cộng 1 cho mọi trường hợp. | Vẽ một đoạn ngắn với 3 khoảng để đếm thử trước khi áp dụng. |
| 12 | Lấy số dư 0 rồi lấy phần tử đầu tiên của chu kì. | Kiểm chứng bằng một vị trí nhỏ đã biết trước khi làm vị trí lớn. |
| 13 | Chỉ xét hai số đầu rồi vội kết luận. | Viết hiệu giữa các số hạng ngay dưới dấu ngoặc giữa chúng. |
| 14 | Áp dụng nhầm nhánh quy tắc vì không để ý vị trí. | Kẻ bảng hai dòng: dòng trên ghi vị trí, dòng dưới ghi số hạng. |
