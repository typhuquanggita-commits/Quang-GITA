...
ten: "Đánh số trang, ma trận số và dãy số dạng đề chuyên — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK1"
tuan: 15
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T2-L5-C08-HD
...
```
CỤM C08 — Đánh số trang, ma trận số và dãy số dạng đề chuyên
├── Bài toán đánh số trang và đếm chữ số trong dãy số
├── Quy luật ma trận số và bảng số
├── Dãy số và bài toán tìm số hạng bị xoá
├── Bài toán dãy số dạng đề chuyên
└── Tổng ôn dãy số và quy luật nâng cao
```

| Buổi | Loại phiếu | Mã phiếu | Sản phẩm phải có sau buổi |
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T2-L5-C08-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T2-L5-C08-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T2-L5-C08-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T2-L5-C08-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T2-L5-C08-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T2-L5-C08-TH` | Điểm bài thi chương |
...
| 3 | Làm lại phiếu `GITA-T2-L5-C08-NC` phần IV và V, chấm bằng phiếu `GITA-T2-L5-C08-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T2-L5-C08-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T2-L5-C08-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T2-L5-C08-NC`** và làm bài tương tự trong phiếu `GITA-T2-L5-C08-NC-GP`, chưa mở cụm mới.
