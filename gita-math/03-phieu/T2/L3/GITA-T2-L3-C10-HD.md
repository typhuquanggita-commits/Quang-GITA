...
ten: "Toán đếm, nguyên lý bù trừ và chia phần — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK2"
tuan: 19
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T2-L3-C10-HD
...
```
CỤM C10 — Toán đếm, nguyên lý bù trừ và chia phần
├── Đếm số theo điều kiện cho trước
├── Suy luận logic: bài toán ai làm việc gì
├── Nguyên lý bù trừ mức làm quen với hai tập hợp
├── Toán chia kẹo: chia phần bằng nhau và phần dư
└── Bài toán suy luận về ngày và thứ trong tuần
```

| Buổi | Loại phiếu | Mã phiếu | Sản phẩm phải có sau buổi |
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T2-L3-C10-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T2-L3-C10-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T2-L3-C10-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T2-L3-C10-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T2-L3-C10-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T2-L3-C10-TH` | Điểm bài thi chương |
...
| 3 | Làm lại phiếu `GITA-T2-L3-C10-NC` phần IV và V, chấm bằng phiếu `GITA-T2-L3-C10-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T2-L3-C10-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T2-L3-C10-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T2-L3-C10-NC`** và làm bài tương tự trong phiếu `GITA-T2-L3-C10-NC-GP`, chưa mở cụm mới.
