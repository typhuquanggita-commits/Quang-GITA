...
- **Bài A.1** — a) ô (Sơn; Tiếng Anh) · b) toàn bộ hàng Sơn và toàn bộ cột Tiếng Anh · c) ô (Hà; Toán) · d) Âm nhạc · e) Toán · f) phương pháp lập bảng và loại trừ
- **Bài A.2** — a) 8 716 · b) số chẵn · c) 47 915 · d) 51 250
- **Bài A.3** — a) 5 chữ số, tổng 31 · b) 5 chữ số, tổng 28 · c) 5 chữ số, tổng 35 · d) 5 chữ số, tổng 19 · e) 5 chữ số, tổng 15
- **Bài A.4** — a) &gt; · b) &gt; · c) &lt; · d) &lt; · e) &lt; · f) &lt; · g) &lt; · h) &lt;
- **Bài A.5** — a) chữ số 2, giá trị 20 000 · b) chữ số 3, giá trị 3 000 · c) chữ số 8, giá trị 800 · d) chữ số 7, giá trị 7
...
- **Bài B.2** — a) “Lập số từ bộ chữ số là:” · b) “Đếm chữ số, tính tổng chữ số là:” · c) “Nhận biết chẵn – lẻ và số liền kề là:” · d) “Xác định chữ số và giá trị chữ số theo hàng là:” · e) “Đếm chữ số theo nhóm là:”
...
- **Bài B.4** — a) Cố định chữ số hàng trăm rồi mới đổi chỗ hai chữ số còn lại. · b) Viết rời từng chữ số ra rồi mới cộng. · c) Liền trước – liền sau chỉ hơn kém đúng **1** đơn vị. · d) Luôn viết số ra nháp rồi đánh dấu hàng đơn vị trước, đi ngược về trái. · e) Kẻ bảng: khoảng trang – số trang – số chữ số. · f) Tính thử vài trường hợp nhỏ để thấy quy luật nhân 9.
...
- **Bài C.2** — a) tầng 2 · b) Cố định chữ số hàng trăm rồi mới đổi chỗ hai chữ số còn lại. · c) toàn bộ số điểm của ý sai · d) Cố định chữ số hàng trăm rồi mới đổi chỗ hai chữ số còn lại. · e) Viết **có thứ tự** thì mới chắc chắn đủ và không lặp.
...
- **Bài C.5** — a) tầng 2 · b) Viết rời từng chữ số ra rồi mới cộng. · c) toàn bộ số điểm của ý sai · d) Viết rời từng chữ số ra rồi mới cộng. · e) Tổng các chữ số **không** phụ thuộc thứ tự các chữ số.
...
- **Bài E.2** — a) “Hôm nay nhóm mình nói về Lập số từ bộ chữ số.” · b) Cho ba chữ số, yêu cầu lập số · c) Cấu tạo số có ba chữ số · d) Từ 1, 2, 3 lập được mấy số có ba chữ số khác nhau? → 6 · e) Viết lộn xộn nên vừa sót vừa trùng. · f) Ba chữ số khác 0 luôn lập được đúng 6 số.
- **Bài E.3** — a) “Hôm nay nhóm mình nói về Nhận biết chẵn – lẻ và số liền kề.” · b) Từ khoá “chẵn”, “lẻ”, “liền trước”, “liền sau” · c) Dãy số tự nhiên liên tiếp, dấu hiệu chia hết cho 2 · d) Số liền sau của 19 662 là số nào? → 19 663 · e) Nhầm “liền trước” với “bé hơn”, trả lời một số bất kì bé hơn. · f) Che hết các chữ số, chỉ để lộ chữ số cuối.
- **Bài E.4** — a) “Hôm nay nhóm mình nói về Đếm chữ số theo nhóm.” · b) Bài toán đánh số trang · c) Đếm số hạng, cấu tạo số · d) Vở 20 trang dùng hết bao nhiêu chữ số? → 31 · e) Lấy số trang nhân với 2 hoặc 3 cho toàn bộ. · f) Sách 99 trang dùng đúng 189 chữ số — nhớ mốc này.
...
### Bài D.5 — Nhánh 4 — So sánh hai số tự nhiên
...
### Bài E.2 — Nội dung giảng — Lập số từ bộ chữ số

**BẪY — Viết lộn xộn nên vừa sót vừa trùng..** Chọn chữ số hàng trăm trước, rồi hàng chục, rồi hàng đơn vị; mỗi chữ số dùng đúng một lần. Viết theo nhóm cùng chữ số hàng trăm để không sót và không trùng.

*Điểm chốt:* Viết **có thứ tự** thì mới chắc chắn đủ và không lặp.

### Bài E.3 — Nội dung giảng — Nhận biết chẵn – lẻ và số liền kề

Số chẵn là số có chữ số tận cùng 0, 2, 4, 6, 8; số lẻ tận cùng 1, 3, 5, 7, 9. Số liền trước kém 1 đơn vị, số liền sau hơn 1 đơn vị. Hai số chẵn liên tiếp hơn kém nhau 2 đơn vị.

*Điểm chốt:* Chỉ cần nhìn **chữ số tận cùng** là biết chẵn hay lẻ, dù số dài bao nhiêu.

### Bài E.4 — Nội dung giảng — Đếm chữ số theo nhóm
...
|---|---|---|---|---|---|---|
| A.1 | Suy luận loại trừ có bảng | Phương pháp lập bảng, loại trừ | Mỗi người ứng với đúng một đối tượng, đề cho các dữ kiện phủ định | Kẻ bảng, đánh dấu, lan toả theo hàng và cột | Bắt đầu từ dữ kiện khẳng định (“thích”, “là”) trước dữ kiện phủ định. | ô (Sơn; Tiếng Anh) · toàn bộ hàng Sơn và toàn bộ cột Tiếng Anh · ô (Hà; Toán) · Âm nhạc… |
| A.2 | Nhận biết chẵn – lẻ và số liền kề | Dãy số tự nhiên liên tiếp, dấu hiệu chia hết cho 2 | Từ khoá “chẵn”, “lẻ”, “liền trước”, “liền sau” | Xét chữ số tận cùng; cộng hoặc trừ 1 đơn vị | Che hết các chữ số, chỉ để lộ chữ số cuối. | 8 716 · số chẵn · 47 915 · 51 250 |
| A.3 | Đếm chữ số, tính tổng chữ số | Cấu tạo số, tổng chữ số | Yêu cầu “có mấy chữ số”, “tổng các chữ số” | Tách lớp để đếm; cộng rời từng chữ số | Ghép cặp các chữ số cộng lại tròn 10 rồi cộng nhanh. | 5 chữ số, tổng 31 · 5 chữ số, tổng 28 · 5 chữ số, tổng 35 · 5 chữ số, tổng 19… |
...
| A.5 | Xác định chữ số và giá trị chữ số theo hàng | Cấu tạo thập phân của số tự nhiên | Đề hỏi “chữ số hàng …” hoặc “giá trị của chữ số …” | Đánh số hàng từ phải sang trái rồi tra bảng hàng | Đếm số chữ số đứng sau chữ số cần tìm — đó chính là số chữ số 0 phải viết thêm khi ghi giá trị. | chữ số 2, giá trị 20 000 · chữ số 3, giá trị 3 000 · chữ số 8, giá trị 800 · chữ số 7, giá trị 7 |
...
| B.2 | Kỹ năng viết câu lời giải | Chuẩn trình bày | Đề hỏi gì thì câu lời giải nhắc lại điều đó | Lấy cụm từ trong câu hỏi làm câu lời giải | Sao chép cụm từ trong câu hỏi là cách viết câu lời giải nhanh và chắc nhất. | “Lập số từ bộ chữ số là:” · “Đếm chữ số, tính tổng chữ số là:” · “Nhận biết chẵn – lẻ và số liền kề là:” · “Xác định chữ số và giá trị chữ số theo hàng là:”… |
...
| B.4 | Sổ lỗi và cách phòng | Lỗi thường gặp của chương | Cột “Lỗi thường gặp” trong bảng phân tích | Ghép cặp lỗi với cách phòng | Đọc lại sổ lỗi 3 phút trước mỗi bài kiểm tra. | Cố định chữ số hàng trăm rồi mới đổi chỗ hai chữ số còn lại. · Viết rời từng chữ số ra rồi mới cộng. · Liền trước – liền sau chỉ hơn kém đúng **1** đơn vị. · Luôn viết số ra nháp rồi đánh dấu hàng đơn vị trước, đi ngược về trái.… |
...
| C.2 | TD4, TD3 | Viết **có thứ tự** thì mới chắc chắn đủ và không lặp. |
...
| C.5 | TD1 | Tổng các chữ số **không** phụ thuộc thứ tự các chữ số. |
...
| D.5 | TD1, TD5 | Đếm số chữ số **trước**, chỉ khi bằng nhau mới so từng hàng. |
| E.1 | TD3, TD6 | Giảng được cho bạn hiểu mới là **đã hiểu**. |
| E.2 | TD4, TD3 | Viết **có thứ tự** thì mới chắc chắn đủ và không lặp. |
| E.3 | TD1 | Chỉ cần nhìn **chữ số tận cùng** là biết chẵn hay lẻ, dù số dài bao nhiêu. |
| E.4 | TD4, TD6 | Nhóm cuối cùng **không đầy đủ** — phải đếm đúng số trang còn lại. |
...
| C.2 | Viết lộn xộn nên vừa sót vừa trùng. | Cố định chữ số hàng trăm rồi mới đổi chỗ hai chữ số còn lại. |
...
| C.5 | Cộng cả giá trị hàng (ví dụ cộng 300 thay vì cộng 3). | Viết rời từng chữ số ra rồi mới cộng. |
...
| D.5 | So từ hàng đơn vị (phải sang trái) nên kết luận sai. | Gạch chân cặp chữ số khác nhau đầu tiên tính từ bên trái. |
| E.1 | Đọc thuộc lòng phiếu thay vì giảng bằng lời của mình. | Cấm cầm phiếu khi thuyết trình; chỉ được cầm sơ đồ tư duy tự vẽ. |
| E.2 | Viết lộn xộn nên vừa sót vừa trùng. | Cố định chữ số hàng trăm rồi mới đổi chỗ hai chữ số còn lại. |
...
| A.2 | Số liền sau của 8 717 là số nào? | 8 718 |
| A.3 | Số 40 506 có mấy chữ số và tổng các chữ số bằng bao nhiêu? | 5 chữ số, tổng 15 |
| A.4 | Điền dấu: 50 782 … 50 783 | &lt; |
| A.5 | Chữ số hàng chục của số 23 857 có giá trị bao nhiêu? | 50 |
...
| C.2 | Từ 1, 2, 3 lập được mấy số có ba chữ số khác nhau? | 6 |
| C.3 | Chữ số hàng chục của số 48 265 có giá trị bao nhiêu? | 60 |
