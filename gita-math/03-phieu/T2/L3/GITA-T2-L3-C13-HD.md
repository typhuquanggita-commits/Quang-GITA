...
ten: "So sánh biểu thức và tính nhanh nâng cao — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK2"
tuan: 26
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T2-L3-C13-HD
...
```
CỤM C13 — So sánh biểu thức và tính nhanh nâng cao
├── Tính nhanh biểu thức có thừa số 0 và thừa số chung
├── So sánh hai biểu thức không cần tính giá trị
├── Tính nhanh tổng các số theo quy luật
...
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T2-L3-C13-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T2-L3-C13-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T2-L3-C13-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T2-L3-C13-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T2-L3-C13-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T2-L3-C13-TH` | Điểm bài thi chương |
...
| 2 | Tìm x hai bước | Quan hệ các thành phần của phép tính |
| 3 | Nhân, chia số tự nhiên | Kĩ thuật đặt tính nhân, chia |
| 4 | Tính nhanh biểu thức đơn giản | Tính chất giao hoán, kết hợp; nhân với 0 |
| 5 | Nhân nhẩm nhờ tách thừa số | Nhân một số với một tổng, một hiệu |
| 6 | Tính nhanh tổng | Làm tròn; cộng trừ trong phạm vi trăm nghìn |
| 7 | Tổng dãy số tự nhiên liên tiếp | Ghép cặp, tổng dãy cách đều |
| 8 | Tính nhanh tổng nhiều số hạng | Tính chất giao hoán, kết hợp của phép cộng |
...
| 3 | Làm lại phiếu `GITA-T2-L3-C13-NC` phần IV và V, chấm bằng phiếu `GITA-T2-L3-C13-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T2-L3-C13-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
- [ ] **3.** Em nêu được dấu hiệu nhận biết của dạng “Tìm x hai bước” chứ?
- [ ] **4.** Em nhớ công thức: Quan hệ các thành phần của phép tính?
- [ ] **5.** Em nêu được dấu hiệu nhận biết của dạng “Nhân, chia số tự nhiên” chứ?
- [ ] **6.** Em nhớ công thức: Kĩ thuật đặt tính nhân, chia?
- [ ] **7.** Em nêu được dấu hiệu nhận biết của dạng “Tính nhanh biểu thức đơn giản” chứ?
- [ ] **8.** Em nhớ công thức: Tính chất giao hoán, kết hợp; nhân với 0?
...
- [ ] **11.** Em nêu được dấu hiệu nhận biết của dạng “Tính nhanh tổng” chứ?
- [ ] **12.** Em nhớ công thức: Làm tròn; cộng trừ trong phạm vi trăm nghìn?
- [ ] **13.** Em nêu được dấu hiệu nhận biết của dạng “Tổng dãy số tự nhiên liên tiếp” chứ?
- [ ] **14.** Em nhớ công thức: Ghép cặp, tổng dãy cách đều?
- [ ] **15.** Em nêu được dấu hiệu nhận biết của dạng “Tính nhanh tổng nhiều số hạng” chứ?
- [ ] **16.** Em nhớ công thức: Tính chất giao hoán, kết hợp của phép cộng?
- [ ] **17.** Em nêu được dấu hiệu nhận biết của dạng “Tính giá trị biểu thức” chứ?
- [ ] **18.** Em nhớ công thức: Thứ tự thực hiện các phép tính?
- [ ] **19.** Em nêu được dấu hiệu nhận biết của dạng “Cộng, trừ số tự nhiên” chứ?
- [ ] **20.** Em nhớ công thức: Kĩ thuật đặt tính, nhớ và mượn?
...
| 4 | Lao vào tính từ trái sang phải, bỏ lỡ mọi lối tắt. | Đọc hết biểu thức một lượt trước khi đặt bút. |
| 5 | Nhân với 10 rồi quên bù trừ phần chênh. | Viết luôn dấu cộng hoặc trừ và số bù ra bên cạnh trước khi nhân. |
| 6 | Lấy tổng đã làm tròn ra trả tiền. | Nhẩm xong luôn hỏi: con số này để ước chừng hay để trả tiền? |
| 7 | Cộng dồn từ đầu đến cuối, rất lâu và dễ sai. | Viết ra ba cặp đầu để thấy rõ các cặp có cùng tổng. |
| 8 | Cộng lần lượt từ trái sang phải nên bỏ lỡ cặp số tròn. | Đọc lướt cả dãy, khoanh tròn cặp số cộng lại tròn chục, tròn trăm. |
| 9 | Viết lệch hàng khi hai số có số chữ số khác nhau. | Kẻ cột dọc cho từng hàng trước khi viết số. |
| 10 | Quên chữ số 0 ở giữa thương nên thương thiếu chữ số. | Đếm trước xem thương có mấy chữ số rồi mới chia. |
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T2-L3-C13-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T2-L3-C13-NC`** và làm bài tương tự trong phiếu `GITA-T2-L3-C13-NC-GP`, chưa mở cụm mới.
