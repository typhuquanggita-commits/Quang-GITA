...
| 2 | Đếm chữ số theo nhóm | Đếm số hạng, cấu tạo số |
...
| 6 | Lập số từ bộ chữ số | Cấu tạo số có ba chữ số |
...
- [ ] **3.** Em nêu được dấu hiệu nhận biết của dạng “Đếm chữ số theo nhóm” chứ?
- [ ] **4.** Em nhớ công thức: Đếm số hạng, cấu tạo số?
...
- [ ] **11.** Em nêu được dấu hiệu nhận biết của dạng “Lập số từ bộ chữ số” chứ?
- [ ] **12.** Em nhớ công thức: Cấu tạo số có ba chữ số?
...
| 2 | Lấy số trang nhân với 2 hoặc 3 cho toàn bộ. | Kẻ bảng: khoảng trang – số trang – số chữ số. |
...
| 6 | Viết lộn xộn nên vừa sót vừa trùng. | Cố định chữ số hàng trăm rồi mới đổi chỗ hai chữ số còn lại. |
