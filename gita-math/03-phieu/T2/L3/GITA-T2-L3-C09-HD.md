...
| 5 | So sánh hai số tự nhiên | Thứ tự trong tập số tự nhiên |
| 6 | Đếm chữ số, tính tổng chữ số | Cấu tạo số, tổng chữ số |
| 7 | Lập số từ bộ chữ số | Cấu tạo số có ba chữ số |
| 8 | Đếm chữ số theo nhóm | Đếm số hạng, cấu tạo số |
| 9 | Tìm thành phần chưa biết; tính chất phép nhân | Quan hệ các thành phần phép tính; giao hoán, kết hợp, nhân 0 và 1 |
| 10 | Nhận biết chẵn – lẻ và số liền kề | Dãy số tự nhiên liên tiếp, dấu hiệu chia hết cho 2 |
| 11 | Kiểm tra chia hết bằng dấu hiệu | Dấu hiệu chia hết cho 2, 3, 5, 9 |
| 12 | Chữ số tận cùng | Tính chất chữ số tận cùng của tổng, tích |
...
- [ ] **7.** Em nêu được dấu hiệu nhận biết của dạng “Đổi chỗ chữ số” chứ?
- [ ] **8.** Em nhớ công thức: Cấu tạo số có hai chữ số?
- [ ] **9.** Em nêu được dấu hiệu nhận biết của dạng “Phép chia có dư” chứ?
- [ ] **10.** Em nhớ công thức: Quan hệ giữa số bị chia, số chia, thương và số dư?
...
- [ ] **15.** Em nêu được dấu hiệu nhận biết của dạng “Lập số từ bộ chữ số” chứ?
- [ ] **16.** Em nhớ công thức: Cấu tạo số có ba chữ số?
- [ ] **17.** Em nêu được dấu hiệu nhận biết của dạng “Đếm chữ số theo nhóm” chứ?
- [ ] **18.** Em nhớ công thức: Đếm số hạng, cấu tạo số?
- [ ] **19.** Em nêu được dấu hiệu nhận biết của dạng “Tìm thành phần chưa biết; tính chất phép nhân” chứ?
- [ ] **20.** Em nhớ công thức: Quan hệ các thành phần phép tính; giao hoán, kết hợp, nhân 0 và 1?
...
| 4 | Coi hiệu hai số bằng hiệu hai chữ số. | Tính thử vài trường hợp nhỏ để thấy quy luật nhân 9. |
| 5 | Để số dư lớn hơn số chia, hoặc quên hạ chữ số 0 nên thương thiếu chữ số. | Thử lại bằng công thức số bị chia = số chia × thương + số dư. |
...
| 8 | Viết lộn xộn nên vừa sót vừa trùng. | Cố định chữ số hàng trăm rồi mới đổi chỗ hai chữ số còn lại. |
| 9 | Lấy số trang nhân với 2 hoặc 3 cho toàn bộ. | Kẻ bảng: khoảng trang – số trang – số chữ số. |
| 10 | Áp dụng quy tắc của số trừ cho số bị trừ. | Viết ra vai trò của x trước khi viết phép tính. |
| 11 | Nhầm “liền trước” với “bé hơn”, trả lời một số bất kì bé hơn. | Liền trước – liền sau chỉ hơn kém đúng **1** đơn vị. |
| 12 | Dùng dấu hiệu của 3 để kết luận cho 2. | Ghi tổng các chữ số ra bên cạnh trước khi kết luận. |
