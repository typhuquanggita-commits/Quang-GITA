...
ten: "Cấu tạo số và tính chẵn lẻ — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK1"
tuan: 1
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T2-L3-C01-HD
...
```
CỤM C01 — Cấu tạo số và tính chẵn lẻ
├── Cấu tạo thập phân của số — viết số thành tổng
├── Số chẵn – số lẻ: tính chẵn lẻ của tổng và của tích
├── Cấu tạo số: bài toán viết thêm, xoá bớt chữ số
├── Chữ số tận cùng của tổng và của tích
├── Bài toán về số có ba chữ số thoả điều kiện cho trước
└── Bài toán về số có bốn chữ số và điều kiện của chữ số
```

| Buổi | Loại phiếu | Mã phiếu | Sản phẩm phải có sau buổi |
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T2-L3-C01-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T2-L3-C01-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T2-L3-C01-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T2-L3-C01-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T2-L3-C01-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T2-L3-C01-TH` | Điểm bài thi chương |
...
| 3 | Làm lại phiếu `GITA-T2-L3-C01-NC` phần IV và V, chấm bằng phiếu `GITA-T2-L3-C01-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T2-L3-C01-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T2-L3-C01-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T2-L3-C01-NC`** và làm bài tương tự trong phiếu `GITA-T2-L3-C01-NC-GP`, chưa mở cụm mới.
