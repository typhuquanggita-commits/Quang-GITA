...
ten: "Đại lượng, thời gian và toán thực tế — Hướng dẫn ôn chắc chuyên đề"
hoc_ky: "HK1"
tuan: 15
---

# PHIẾU HƯỚNG DẪN ÔN CHẮC CHUYÊN ĐỀ · GITA-T2-L3-C08-HD
...
```
CỤM C08 — Đại lượng, thời gian và toán thực tế
├── Đổi đơn vị đo độ dài, khối lượng — bài toán ngược
├── Bài toán thời gian: khoảng thời gian và thời điểm
├── Bài toán về tiền: đổi tiền và đếm số cách trả tiền
├── Bài toán về khối lượng và dung tích tổng hợp
├── Bài toán thực tế về đo lường và mua bán
└── Tổng ôn đại lượng và toán thực tế
```

| Buổi | Loại phiếu | Mã phiếu | Sản phẩm phải có sau buổi |
|:--:|---|---|---|
| 1 | Lý thuyết | `GITA-T2-L3-C08-LT` | Sơ đồ tư duy chương tự vẽ |
| 2 | Dạng bài & Đọc vị | `GITA-T2-L3-C08-DB` | Bảng dạng bài — dấu hiệu điền đủ |
| 3 | Kỹ năng & Phương pháp | `GITA-T2-L3-C08-KN` | Sổ lỗi và kịch bản thuyết trình |
| 4 | Luyện nâng cao | `GITA-T2-L3-C08-NC` | Bài IV, V đã chữa và ghi lỗi |
| 5 | Ôn thi | `GITA-T2-L3-C08-OT` | Điểm bài ôn và bảng phân tích lỗi |
| 6 | Thi chương | `GITA-T2-L3-C08-TH` | Điểm bài thi chương |
...
| 3 | Làm lại phiếu `GITA-T2-L3-C08-NC` phần IV và V, chấm bằng phiếu `GITA-T2-L3-C08-NC-GP` | 60 phút | Sổ lỗi cập nhật |
| 4 | Làm lại phiếu `GITA-T2-L3-C08-TH` trong đúng 90 phút, tự chấm | 90 phút | Điểm và bảng phân tích lỗi |
...
| # | Tiêu chí | Ngưỡng đạt |
|---:|---|---|
| 1 | Điểm phiếu thi chương `GITA-T2-L3-C08-TH` | ≥ 80/100 |
...
Chưa đạt thì **học lại phiếu `GITA-T2-L3-C08-NC`** và làm bài tương tự trong phiếu `GITA-T2-L3-C08-NC-GP`, chưa mở cụm mới.
