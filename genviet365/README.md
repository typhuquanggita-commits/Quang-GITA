...
**36 nhóm · 222 màn · 17 vai.** Có ô tìm — gõ `/` để nhảy vào. Không cần cài gì, không có bước dựng.
...
| `man-hinh.js` | `GV.NHOM` (36 nhóm điều hướng) · `GV.MAN` (222 màn, mỗi màn là danh sách KHỐI) · `GV.TU` (bảng tra nối khối tới dữ liệu) |
...
Rồi mở thử toàn bộ 222 màn ở cả hai chế độ sáng và tối, và ở khổ điện thoại — bộ kiểm cần
