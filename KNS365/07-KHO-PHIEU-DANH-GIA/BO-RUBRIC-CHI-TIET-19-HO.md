# BỘ RUBRIC CHI TIẾT · **19 HỌ NĂNG LỰC**
### Chuẩn viết rubric GITA · 19 rubric gốc đầy đủ · quy đổi TT27/2020 & TT22/2021

> **Vấn đề tài liệu này giải quyết:** kho đánh giá có **288 mã rubric**, nhưng huấn luyện viên không thể chấm bằng một danh mục mã. Tài liệu này cung cấp **19 rubric gốc — mỗi họ năng lực một cái, viết đầy đủ 4 mức** — làm khuôn để biên soạn 269 rubric còn lại một cách nhất quán.
>
> 🎯 **Nguyên tắc lớn nhất:** rubric của KNS365 mô tả **hành vi quan sát được**, không mô tả phẩm chất bên trong.
> ✅ *"Nói được câu đầu tiên trong 3 giây"* — ❌ *"Tự tin"*.
> Lý do: hai huấn luyện viên chấm cùng một học sinh phải ra kết quả gần nhau *(ngưỡng khớp ≥80%, xem `14/01` mục B3)*. Không ai đo được "tự tin"; ai cũng đo được "3 giây".

---

## PHẦN A. CHUẨN VIẾT MỘT RUBRIC GITA

### A1. Cấu trúc bắt buộc
...
**Quy đổi tổng điểm** *(rubric 5 tiêu chí, /20)*:
...
```
 ✅ 1 điều ĐÚNG:            ………………………………………………………
 🔧 1 điều CHỈNH duy nhất:  ………………………………………………………
 ⏱️ Làm lại ngay 20 giây:   ☐ đã làm      Người chấm: …………  Ngày: ………
```
...
| 3. Giữ cam kết đã nói | Nói rồi quên | Giữ được khi có người theo dõi | **Giữ ≥80% cam kết đã ghi trong `PSM`** | Giữ 100%; chủ động báo trước khi không giữ được |
| 4. Nhận trách nhiệm khi sai | Đổ lỗi hoàn cảnh | Thừa nhận khi được chỉ ra | **Tự nhận và nêu cách sửa** | Nhận, sửa, và nêu cách phòng ngừa lần sau |
| 5. Tự đánh giá | Không nêu được | Nêu chung chung | **Nêu đúng mức của mình, có dẫn chứng** | Dự đoán được mức trước khi chấm, sai lệch ≤1 mức |
...
| 3. Nhận diện rào cản | Không lường trước | Nêu 1 rào cản | **Nêu ≥3 rào cản kèm phương án** | Có phương án B cho rào cản lớn nhất |
| 4. Bám kế hoạch | <60% | 60–79% | **≥85% trong chu kỳ** | ≥95%; điều chỉnh có ghi lý do |
| 5. Rà soát & điều chỉnh | Không rà | Rà khi được nhắc | **Rà theo lịch, điều chỉnh có căn cứ** | Điều chỉnh **bằng dữ liệu**, giữ nguyên đích |
...
| 3. Chuỗi ngày | <7 ngày | 7–20 ngày | **≥21 ngày liên tục** | **≥90 ngày** |
| 4. Phục hồi khi đứt | Đứt là bỏ | Nối lại sau vài ngày | **Nối lại trong ≤2 ngày** | Nối lại ngay hôm sau; ghi nguyên nhân đứt |
| 5. Bằng chứng | Không ghi | Ghi không đều | **Bảng Chuỗi Ngày đầy đủ, có người chứng** | Có người chứng ký + dữ liệu ≥2 chu kỳ |
...
| 3. ĐI KHỎI | Đứng lại | Đi sau khi ngập ngừng | **Quay người đi ngay, không giải thích** | Đi khỏi và chọn hướng về phía người tin cậy |
| 4. KỂ LẠI | Không kể | Kể khi được hỏi | **Chủ động kể, nêu được sự việc thành câu** | Kể nêu rõ **ai – làm gì – lúc nào**; kể tiếp người thứ 2 nếu chưa được giúp |
| 5. Bàn Tay Tin Cậy | Chưa nêu được ai | Nêu 1–2 người | **Nêu đủ ≥3 người, có người ở nhà và ở trường** | Đã **thực sự nói chuyện** với ≥1 người trong đó |

> ⚠️ Rubric này **không chấm điểm cá nhân công khai**. Chấm theo Squad hoặc ghi riêng vào hồ sơ. Học sinh dùng quyền "pass" **không bị đánh giá thấp**.
...
| 3. Vận động | Không vận động | Vận động khi có tổ chức | **≥30 phút/ngày, ≥5 ngày/tuần** | Duy trì ≥90 ngày; rủ được người khác cùng |
| 4. Vệ sinh cá nhân | Cần nhắc | Làm khi nhắc | **Tự làm đủ, không cần nhắc** | Tự nhận ra khi cần điều chỉnh theo hoàn cảnh |
| 5. Nhận biết dấu hiệu bất ổn | Không nhận ra | Nhận ra khi nặng | **Nhận ra sớm và báo người lớn** | Mô tả được dấu hiệu bằng từ chính xác |
...
| 3. Dùng kỹ thuật hạ nhiệt | Không dùng | Dùng khi HLV nhắc | **Tự dùng ≥1 kỹ thuật, có hiệu quả** | Chọn đúng kỹ thuật theo tình huống, có ≥2 kỹ thuật |
| 4. Nói ra thay vì hành động | Bùng nổ hoặc im lặng | Nói được sau khi nguôi | **Nói được cảm xúc bằng câu "Tớ thấy… vì…"** | Nói được ngay lúc căng mà không đổ lỗi |
| 5. Tôn trọng cảm xúc người khác | Chê cảm xúc của bạn | Im lặng nghe | **Ghi nhận cảm xúc bạn bằng lời** | Hỏi thay vì khuyên; không vội an ủi |
...
| 3. Tìm nguyên nhân | Đổ lỗi hoặc bỏ qua | Nêu 1 nguyên nhân | **Phân loại được nhóm lỗi** *(chưa học / hiểu sai / cẩu thả)* | Nêu nguyên nhân gốc và cách phòng ngừa |
| 4. Thử lại có điều chỉnh | Thử lại y hệt | Thử lại có đổi chút | **Thử lại với đúng 1 điều chỉnh có chủ đích** | Ghi lại kết quả từng lần thử, so sánh được |
| 5. Giữ nhịp khi khó | Bỏ nhịp | Giữ được vài ngày | **Giữ nhịp qua ≥1 lần thất bại lớn** | Giữ qua **≥2 khủng hoảng**, có nhật ký xử lý |
...
| 3. Nhắc lại để xác nhận | Không nhắc lại | Nhắc lại chưa đúng ý | **Nhắc lại đúng ý: *"Ý bạn là…"*** | Nhắc lại cả **cảm xúc** phía sau lời nói |
| 4. Đặt câu hỏi | Không hỏi | Hỏi câu đóng | **Hỏi ≥2 câu mở, đúng chủ đề** | Hỏi câu đào sâu; hỏi thay vì khuyên |
| 5. Phản hồi tôn trọng | Chê hoặc im | Khen chung chung | **Phản hồi 1-1-1 đúng cấu trúc** | Phản hồi cụ thể, người nghe làm khác đi được ngay |
...
| 3. Mắt & tư thế | Cúi, nhìn giấy | Nhìn lên ngắt quãng | **Nhìn khán giả ≥50% thời gian, đứng vững** | Quét mắt đủ 3 khu vực phòng |
| 4. Cấu trúc | Rời rạc | Có mở – thân | **Đủ mở – thân – kết, đúng thời lượng ±10%** | Kết có câu chốt mang về được |
| 5. Xử lý sự cố | Dừng, bỏ dở | Lúng túng rồi tiếp | **Quên vẫn tiếp tục được trong ≤5 giây** | Xử lý câu hỏi khó/nhiễu mà không mất mạch |
...
| 3. Nhường & chia việc | Ôm hết hoặc không làm | Chia khi được nhắc | **Chia việc để 100% thành viên có phần** | Chia theo điểm mạnh từng người |
| 4. Xử lý bất đồng | Cãi hoặc rút lui | Im để giữ hoà khí | **Nêu ý khác mà không hạ thấp người khác** | Đưa được phương án dung hoà có căn cứ |
| 5. Giữ nhóm khi khó | Rời nhóm | Ở lại nhưng thụ động | **Ở lại và làm phần mình khi nhóm gặp khó** | Giữ được tinh thần nhóm; không ai bỏ giữa chừng |
...
| 3. Tạo phương án | Chỉ 1 cách | 2 cách | **≥3 phương án khác nhau về bản chất** | Có phương án chi phí thấp và phương án dự phòng |
| 4. Cân nhắc & chọn | Chọn theo cảm tính | Nêu ưu nhược sơ sài | **So sánh theo ≥2 tiêu chí đã nêu trước** | Nêu rõ điều mình đánh đổi khi chọn |
| 5. Kiểm chứng sau khi làm | Không xem lại | Xem lại khi hỏng | **Rà kết quả và rút bài học ghi lại** | Điều chỉnh cách nghĩ, không chỉ cách làm |
...
| 3. Chọn ý để thử | Chọn ngẫu nhiên | Chọn ý mình thích | **Chọn theo tiêu chí đã nêu trước** | Chọn ý **thử được rẻ nhất** trước |
| 4. Làm mẫu thử | Chỉ nói, không làm | Mô tả bằng hình | **Làm được mẫu thử thô trong buổi** | Mẫu thử đủ để người khác dùng thử và góp ý |
| 5. Học từ phản hồi | Bỏ khi bị chê | Sửa theo lời chê | **Thu phản hồi ≥3 người rồi mới sửa** | Phân biệt phản hồi cần theo và không cần theo |
...
| 3. Phân bổ thời gian | Chia đều | Có ưu tiên cảm tính | **Phân bổ 20/80 theo dữ liệu điểm mất** | Lồng 2 tầng: theo môn và theo dạng bài |
| 4. Tự kiểm tra | Không tự kiểm | Kiểm khi có đề | **Tự kiểm theo lịch, có sổ lỗi** | Dự đoán điểm trước khi làm, sai lệch ≤1 điểm |
| 5. Điều chỉnh | Không điều chỉnh | Điều chỉnh theo cảm giác | **Điều chỉnh có số liệu làm căn cứ** | ≥3 lần điều chỉnh, kết quả tăng liên tục |
...
| 3. Ứng xử với người khác | Bình luận thiếu tôn trọng | Im lặng | **Ứng xử tôn trọng; không tham gia công kích** | Bênh vực người bị công kích đúng cách |
| 4. Xử lý khi bị bắt nạt mạng | Chịu đựng một mình | Kể sau thời gian dài | **Lưu bằng chứng và báo người lớn ngay** | Hỗ trợ được bạn khác làm đúng quy trình |
| 5. Quản lý thời gian màn hình | Không kiểm soát | Biết mình dùng nhiều | **Đặt và giữ giới hạn ≥5/7 ngày** | Tự thiết kế môi trường giảm cám dỗ |
...
| 3. Lập ngân sách | Không có | Có nhưng không theo | **Ngân sách cân đối, bám ≥80%** | Có khoản dự phòng ≥10% và giữ được |
| 4. Tiết kiệm có mục tiêu | Không tiết kiệm | Tiết kiệm ngắt quãng | **Đạt ≥1 mục tiêu tiết kiệm đã đặt** | Đạt ≥2 mục tiêu; hoãn được nhu cầu trước mắt |
| 5. Nhận diện rủi ro | Không nhận ra | Nhận ra khi được cảnh báo | **Nhận ra chiêu dụ mua và lừa đảo phổ biến** | Giải thích lại được cho người khác |
...
| 3. Ngân sách & nguồn lực | Không tính | Ước lượng thô | **Ngân sách chi tiết, cân đối, có dự phòng** | Xác định đúng loại nguồn lực cần, không chỉ tiền |
| 4. Tiếp cận nguồn lực | Ngại xin | Xin chưa đúng cách | **Có bộ hồ sơ, tiếp cận ≥3 nguồn** | Huy động được ≥1 nguồn thật; giữ quan hệ sau đó |
| 5. Minh bạch & trách nhiệm | Không báo cáo | Báo khi được hỏi | **Sổ quỹ đủ chứng từ, công khai định kỳ** | Báo cáo minh bạch **cả khi kết quả không như hứa** |
...
| 3. Đối chiếu bản thân – nghề | Chọn theo cảm tính | Nêu vài điểm hợp | **Đối chiếu theo ≥3 tiêu chí cụ thể** | Nêu rõ phần mình còn thiếu và cách bù |
| 4. Lộ trình | Không có | Có mục tiêu xa | **Có mốc gần – trung – xa với hành động cụ thể** | Có ≥2 kịch bản và điều kiện chuyển hướng |
| 5. Hành động thử | Chưa làm gì | Đọc tìm hiểu | **Đã làm ≥1 việc thật liên quan đến hướng chọn** | Có sản phẩm/minh chứng đưa vào Talent Portfolio |
...
| 3. Giữ nhịp | Để trôi | Nhắc khi sát hạn | **Có mốc kiểm tra định kỳ, bám được** | Phát hiện chậm tiến độ trước khi trễ hạn |
| 4. Xử lý người đuối | Bỏ qua hoặc gay gắt | Nhắc trước nhóm | **Gặp riêng, tìm nguyên nhân, hỗ trợ** | Điều chỉnh vai cho phù hợp thay vì loại bỏ |
| 5. Trao lại & phát triển người | Giữ hết quyền | Giao việc nhỏ | **Uỷ quyền ≥2 việc kèm hướng dẫn** | **Có người kế nhiệm làm được khi mình vắng** |
...
| 3. Hệ chỉ số | Không có | Chỉ có đầu ra | **≥1 đầu ra + ≥1 kết quả, có số liệu nền** | Có chỉ số tác động + **bên thứ ba xác nhận** |
...
## PHẦN C. CÁCH DÙNG 19 RUBRIC GỐC ĐỂ VIẾT 269 RUBRIC CÒN LẠI

| Bước | Việc làm |
|:--:|---|
| **1** | Tìm **họ rubric** của chuyên đề trong dòng *"Đánh giá"* của file `KHOI-xx.md` |
...
> 💡 **Ước tính công sức:** với khuôn sẵn, mỗi rubric mất **20–30 phút**. 269 rubric ≈ **110–135 giờ** — chia cho đội 5 người là **khoảng 4 tuần làm việc bán thời gian**. Nên làm **theo mạch**, không làm theo khối, để giữ tính xoắn ốc nhất quán giữa các lớp.
